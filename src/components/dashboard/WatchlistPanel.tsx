...
// 綁定子組件 (組合組件模式)
// 雖然在 TypeScript 中可以直接 export 子組件，但掛載在主組件上符合 Prompt 的組合模式
const WatchlistPanelComposition = Object.assign(WatchlistPanel, {
  Item: WatchlistItemRow,
});

export default WatchlistPanelComposition;
